...
//server components - renderiza no servidor
// podem ser async
// podem chamar recursos do backend (banco de dados)
// não pode usar hooks
//não pode ter interatividade
//não conseguimos acesssar recursos do servidor, como chamar o banco de dados, por exemplo, dentro de Client Components
